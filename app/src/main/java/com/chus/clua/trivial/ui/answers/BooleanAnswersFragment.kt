...
import com.chus.clua.trivial.databinding.FragmentBooleanAnswersBinding
...
@AndroidEntryPoint
class BooleanAnswersFragment : BaseFragment<FragmentBooleanAnswersBinding>() {

    private val args: BooleanAnswersFragmentArgs by navArgs()
    private val viewModel: AnswersViewModel by viewModels()
    override fun getViewBinding() = FragmentBooleanAnswersBinding.inflate(layoutInflater)

    private val action =
        BooleanAnswersFragmentDirections.actionBooleanAnswersFragmentToGameFinishedFragment()
